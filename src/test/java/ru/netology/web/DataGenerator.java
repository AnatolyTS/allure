...
public class DataGenerator {
    ...
    public static String getRandomCity() {
        List<String> list = Arrays.asList("Москва", "Санкт-Петербург", "Казань", "Майкоп", "Нижний Новгород",
    ...
    public static String getNotCorrectNameWithEngSymbol() {
        String notCorrectName = "Victoria Патрина";
        return notCorrectName;
    }
